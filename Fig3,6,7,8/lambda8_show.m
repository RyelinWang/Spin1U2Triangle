...
lambda_1=lambda8Data(:,:);
lambda_2=zeros(size(lambda8Data,1),size(lambda8Data,2));
lambda_3=zeros(size(lambda8Data,1),size(lambda8Data,2));
for l=1:L-1
...
axis off
title(sprintf("\\lambda_{8} configuration, J_2=%.1f,J_1=%.1f ",J_2,J_1),"FontSize",10);
